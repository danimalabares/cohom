...
\begin{ejem}
	...
	\end{tikzcd}\]
	Así que la cohomología es $\Z/2$ si $0\leq i\leq n$ y $0$ en $i>n$. El producto de la clase de grado uno en el primer grupo de cohomología consido misma me va dando los elementos no cero en cada nivel (esto es lo único que no está demostrado en este ejemplo). Es decir, $\alpha_1^i=\alpha_i$ para cualquier $2\leq i\leq n$ y $\alpha^{n+1}_1=0$
	...
	\end{proof}
	\begin{ejem}
		Ahora comparemos $S^\bigvee S^2$ y $\R P^2$, cuyos anillos de cohomología son los dos $\Z/2\oplus\Z/2$. Pero el elemento no trivial de grado 1 $\beta_1$ elevado al cuadrado es 0 porque estamos en el producto directo de los anillos, así que estamos en el producto del primer anillo, es decir
